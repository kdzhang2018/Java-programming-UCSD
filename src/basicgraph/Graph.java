...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> degreeDescending = new ArrayList<Integer>();
		for(int i=numVertices-1; i>=0; i--){
			degreeDescending.add(degree.get(i));
		}
		
		return degreeDescending;
	}
	...
	public static void main (String[] args) {
		...
		GraphLoader.createIntersectionsFile("data/maps/georgetownuniv.map", "data/intersections/georgetownuniv.intersections");
		...
		System.out.println("Distance2 from 1: "+graphFromFile.getDistance2(1));
		System.out.println("****");

		System.out.println("\n****");
		
		System.out.println("Roads / intersections Matrix:");
		...
		System.out.println("Observe all degrees are <= 12.");
		System.out.println("Distance2 from 1: "+graphFromFile2.getDistance2(1));
		System.out.println("****");
		
		// You can test with real road data here.  Use the data files in data/maps
		
		System.out.println("Hollywood data List:");
		GraphAdjList hollywoodGraph = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/hollywood_small.map", hollywoodGraph);
		System.out.println(hollywoodGraph);
		System.out.println("Observe 2 degrees are 8 and 6 degrees are 6.");
		System.out.println("Distance2 from 5: "+hollywoodGraph.getDistance2(5));
		System.out.println("****");
		
		System.out.println("Hollywood data Matrix:");
		GraphAdjMatrix hollywoodGraph2 = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/maps/hollywood_small.map", hollywoodGraph2);
		System.out.println(hollywoodGraph2);
		System.out.println("Observe 2 degrees are 8 and 6 degrees are 6.");
		System.out.println("Distance2 from 5: "+hollywoodGraph2.getDistance2(5));
		System.out.println("****");
